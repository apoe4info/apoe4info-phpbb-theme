...
ApoE4 */
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '<h4 style="line-height:1.1em;padding-top:10px;font-weight:700;font-size:2em;text-align:center;">Community Guidelines</h4><br />
<br />
...
<br />
<b><i>Curiosity</i></b>. Our understanding of the APOE-ε4 allele is evolving. We are skeptical of all ideas including the conventional wisdom, and we express our willingness to learn and to change our minds by asking questions, by sifting through the evidence together, and by acknowledging uncertainty.<br />
<br />
<b><i>Respect</i></b>. All posts and private messages should be courteous. Disagree with ideas, not people. You may not attack, insult, undermine, or belittle anyone. This broad prohibition extends beyond other members and this community to the world at large.<br />
<br />
<b><i>Humility</i></b>. Refrain from posturing as an expert or relying on your professional status to make your point. Support your opinions with personal or clinical experience, your physician’s perspective, and/or published medical research. Avoid overreaching - we are most credible when we focus on our own personal experiences.<br />
<br />
<b><i>Kindness</i></b>. Some here are suffering. Look for the best in one another, and speak with empathy and generosity.<br />
<br />
<b><i>Trust</i></b>. Ulterior financial interests complicate our interactions. Do not self-promote or advertise.<br />
<br />
Respect the privacy of our members. While the <a href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons License</a> that we use allows non-commercial use of the material we create together here, be sensitive to the personal nature of some of what we share. When in doubt as to the wishes of an author whose words you would like to use in another context, ask, and respect the response.<br />
<br />
Effective date: November 1, 2013.<br />
